...
// snapshot to scenarios/coverage-ledger.md, preserving each scenario's "last passing reconstruction"
...
const LEDGER_PATH = new URL("../scenarios/coverage-ledger.md", import.meta.url);
