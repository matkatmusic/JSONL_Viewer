...
var KIND_NAMES = ['snapshot', 'fileAbsent', 'write', 'edit', 'readFull', 'readChunk', 'cat', 'originalFile', 'bashRm', 'bashTruncate', 'bashAppend', 'patchContext', 'bashReadChunk', 'bashExtent', 'bashGrep', 'grepMatches'];
...
function eventHasAnyKind(event, kindNames) {
...
module.exports = {
  ...
  eventHasAnyKind: eventHasAnyKind
};
