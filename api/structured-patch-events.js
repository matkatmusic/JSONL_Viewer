...
// originalFileEventsFromEdits; consumes the already-parsed structuredPatch
...
function hunksHaveContextLine(hunks) {
...
function structuredPatchForEdit(parsed, edit) {
...
function buildPatchContextEvent(jsonlPath, parsed, edit, statusByLine, aliasSet, aliasPaths) {
  ...
  if (!hunksHaveContextLine(structuredPatchForEdit(parsed, edit))) { return null; }
  var isoTimestamp = timestampAt(parsed, edit.line);
  if (!isoTimestamp) { return null; }
  return createKindEvent(jsonlPath, edit.line + 1, isoTimestamp, 'patchContext', {});
}

// patchContext events for the kept edits of this file whose patches carry
// unchanged context lines.
function patchContextEventsFromEdits(jsonlPath, parsed, edits, statusByLine, aliasPaths) {
...
module.exports = {
  patchContextEventsFromEdits: patchContextEventsFromEdits,
  hunksHaveContextLine: hunksHaveContextLine
};
