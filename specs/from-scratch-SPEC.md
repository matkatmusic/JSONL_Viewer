...
- Tasks: #230, #231, #232, #233, #234, #235, #236, #237, #238, #239, #240, #241, #242, #243, #244, #245, #246, #247, #248, #249, #250, #251, #252, #253, #254, #255, #256, #257, #259
...
- Still open, owned by #248/#249 and deliberately untouched by #245/#247/#250: **250 disk-node header collisions** remain, where the double-ringed on-disk node draws *above* the bubble (and its hash below it). The cause is `buildPairWidget`'s `startPx = pair.commits[0].axisPx` — never a `min` over the on-disk instant — so a file whose disk mtime predates its first commit gets a NEGATIVE relative offset and escapes the box. Commit-node collisions are now zero, which is what isolates this to those two tasks.
