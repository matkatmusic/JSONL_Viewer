...
**Page chrome (feedback fixes, 2026-07-25).** Three additions, all driven by
...
- Tasks: #230, #231, #232, #233, #234, #235, #236, #237, #238, #239, #240, #241, #242, #243, #244, #245, #246, #247, #248, #249, #250, #251, #252, #253, #254, #255, #256, #257
...
- Open observation, NOT a regression from #241-#244 and not fixed by them: a ruler tick sits **32 px above** the node it marks, at every zoom level (the offset is constant in canvas space, so sticky and zoom are not involved). It is `.filebox`'s 2 px border plus 30 px top padding — the inset that houses the widget's filename/sub header — between the box's `margin-top: var(--axis-px)` anchor and the `.lane` its nodes are placed in. Pre-existing since #237; the geometry rules involved were not touched by this work. Worth a decision: either shift the lane up by the header inset, or accept it as the widget header's cost.
