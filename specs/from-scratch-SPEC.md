...
- Tasks: #230, #231, #232, #233, #234, #235, #236, #237, #238, #239, #240, #241, #242, #243, #244, #245, #246, #247, #248, #249, #250, #251, #252, #253, #254, #255, #256, #257, #259, #260, #261, #262, #263, #264, #265, #266, #267, #268, #269, #270, #271, #272, #273, #274, #275, #276, #277, #278, #279, #280, #281, #282, #283, #284, #285, #286, #287, #288, #289, #294, #298, #299, #300, #301, #302, #303, #304, #305, #306, #309, #310
...
- **Layer 1 close-out batch, user-verified DONE 2026-07-28 (#294, #299, #300, #301, #302, #303, #304, #305, #306, #309, #310).** All eleven closed in one parallel-worktree pass and merged to jfred@layer-1-milestone: image drawer with header zoom + binary byte route (#299, 43452b1), two-node lane diff reusing the Revision Viewer renderer lifted to `webapp/diff-render.ts` with syntax-highlighted diff lines and patch export (#305, 6b7b891+3df4ae9 — which also closed #294), expanded-row re-layout via `extraGapPx` per the signed-off mockup (#300, 1ede4e9), millisecond ruler labels after the #306 diagnosis proved the geometry honest and the centisecond label the lie (6deb8e0+49029eb), Cancel-with-confirm on an abortable NDJSON view stream (#302, b30b334), per-ladder resolve counter (#303, a0db493), per-file JSONL scan counter with a truthful empty-state (#304, 3d80f8b), the `markMultiEventTicks` O(rows×bubbles) render stall fixed by a snapshot + chunked "drawing the timeline" render (#309, e0c45a2), and the `.loadbar[hidden]` display rule (#310, 15770e4). Follow-ups filed, not blocking: #307 (split-view ± markers), #308 (full-content as a diff-preserving toggle), #311/#312 (drawer node-cycling arrows).
