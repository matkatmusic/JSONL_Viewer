...
type TaskRecord = { taskNumber: number; title?: string; description?: string } & Record<string, unknown>;
...
const openTasks = readTaskFile(join(root, "tasks.json"));
const completedTasks = readTaskFile(join(root, "completedTasks.json"));
