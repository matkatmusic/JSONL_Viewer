...
// Usage: node unified-reconstruct.js <jsonl-folder> <targetFile>
...
if (typeof module !== 'undefined' && typeof require === 'function') {
  ...
  applySingleEdit = require('./replay-edits').applySingleEdit;
...
if (typeof require !== 'undefined' && require.main === module) {
  ...
  var cliResult = reconstructFromFolder(cliArgs[0], cliArgs[1]);
  process.stdout.write(cliResult.content);
  console.error('Patches: ' + cliResult.patches.length);
}
