// Tests for tools/assemble-split-reads.js — stitching chunked Read events
// (offset/limit) from one transcript into a complete per-file copy keyed by
// absolute line number, per the split-read assembly algorithm.

var assert = require('assert');
var h = require('./test-helpers');
var run = h.run;

var asr = require('../tools/assemble-split-reads');
