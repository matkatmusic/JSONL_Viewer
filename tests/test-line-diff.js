#!/usr/bin/env node
// Tests for api/line-diff.js — LCS line diff and diff rendering. Moved (Phase 5)
// from common/diff-engine.js (renamed to line-diff); tests ported verbatim.

var assert = require('assert');
var h = require('./test-helpers');
var run = h.run;
var mod = require('../api/line-diff');
